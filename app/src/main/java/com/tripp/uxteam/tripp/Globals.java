...
public class Globals {
    ...
    static {
        ...
        parisTrip.addAttraction(new Attraction("Saint Chapelle", "saint_chapelle", "https://www.google.com/maps/search/?api=1&query=saint+chapelle", "https://www.tripadvisor.com/Attraction_Review-g187147-d190202-Reviews-Sainte_Chapelle-Paris_Ile_de_France.html", "Adorned with a unique collection of fifteen glass panels and a large rose window forming a veritable wall of light, it is a gem of French Gothic architecture.", new double[]{0, 0, 0, 0}));
