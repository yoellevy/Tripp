...
//
//    private List<Attraction> attractionsNames = new ArrayList<Attraction>();
//
//    MockAttractions() {
...
//        City paris = cities[1];
//
//        attractionsNames.add(new Attraction("Karlov Most",
...
//
//        attractionsNames.add(new Attraction("Staroměstská Radnice",
...
//
//        attractionsNames.add(new Attraction("Pražský Hrad",
...
//
//
//        attractionsNames.add(new Attraction("Arc de Triomphe",
...
//
//
//        attractionsNames.add(new Attraction("Eiffel Tower",
...
//
//        attractionsNames.add(new Attraction("Galeries Lafayette Paris Haussmann",
...
//
//        attractionsNames.add(new Attraction("Les Catacombes",
...
//                new TAGS[]{Romantic, SiteSeeing, Art}));
//
//        attractionsNames.add(new Attraction("Le Crazy Horse",
...
//
//        attractionsNames.add(new Attraction("Fondation Louis Vuitton",
...
//
//        attractionsNames.add(new Attraction("Marché d'Aligre",
...
//
//        attractionsNames.add(new Attraction("The Louvre",
...
//                new TAGS[]{Romantic, SiteSeeing, Art, Concerts}));
//
//        attractionsNames.add(new Attraction("Ménagerie du Jardin des Plantes",
...
//
//        attractionsNames.add(new Attraction("France Miniature",
